...
`Merge-Conflict`, `Implementation-Failed`, `Worktree-Failed`, `Claimed-Dev-N`
...
- Merge only: `Review + Review-Approved`.
...
- `Implementation-Failed` or `Worktree-Failed`: stop dispatching; route to Human Inbox.
